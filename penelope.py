...
class MainMenu(BetterCMD):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.commands = {
            ...
            "Miscellaneous"     :['help', 'modules', 'history', 'reset', 'reload', 'SET', 'DEBUG', 'exit|quit|q|Ctrl+D', 'devilps']
        }
    
    def do_devilps(self, arg):
        """
        devilps: List all active processes with PID and name.
        """
        import os
